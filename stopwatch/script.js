...
document.getElementById("pause").addEventListener("click", function() {
    if (isRunning) {
        ...
        clearInterval(intervalId);
        isRunning = false;
        document.getElementById("pause").innerHTML = "Play"; // Change button text to "Play"
    } else {
        // Play functionality
        isRunning = true;
        document.getElementById("pause").innerHTML = "Pause"; // Change button text to "Pause"
...
document.getElementById("reset").addEventListener("click", function() {
    ...
    document.getElementById("pause").innerHTML = "Pause"; // Reset pause button text
});
